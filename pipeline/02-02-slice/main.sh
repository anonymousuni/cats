...
INPUT_QUEUE_NAME="MQ2_1_$DRY_RUN_ID"
OUTPUT_QUEUE_NAME="MQ2_2_$DRY_RUN_ID"
...
# CODE TO EXECUTE
python3 slice.py $LOCAL_WORK_DIR/main.csv $LOCAL_WORK_DIR/feedback_curves /work /out $OUTPUT_QUEUE_NAME

if [ -f /work/total_slices.txt ]; then
    export NUM_OUTPUTS=$(cat /work/total_slices.txt)
    echo "NUM_OUTPUTS is set to $NUM_OUTPUTS"
else
    echo "Error: /work/total_slices.txt not found."
    exit 1
fi
